(() => {
  ...
  function layout(){
    ...
    if(bgmToggle){const bx=1695,by=158,bw=120,bh=46;bgmToggle.style.setProperty('--bgm-left',`${g.x+bx*g.s}px`);bgmToggle.style.setProperty('--bgm-top',`${g.y+by*g.s}px`);bgmToggle.style.setProperty('--bgm-width',`${bw*g.s}px`);bgmToggle.style.setProperty('--bgm-height',`${bh*g.s}px`);}
